...
More information about the archiving project can be found on the ArchiveTeam wiki: [Last.fm](http://archiveteam.org/index.php?title=Last.fm)
...
Follow the [instructions on the ArchiveTeam wiki](http://archiveteam.org/index.php?title=Warrior) for installing the Warrior, and select the "Last.fm" project in the Warrior interface.
...
**There is a known issue with some packaged versions of rsync. If you get errors during the upload stage, lastfm-grab will not work with your rsync version.**
...
6. `screen su -c "cd /home/archiveteam/lastfm-grab/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam`
...
Have an issue not listed here? Join us on IRC and ask! We can be found at irc.efnet.org #lastchance.fm.
