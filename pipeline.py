...
LUA_SHA1 = get_hash(os.path.join(CWD, 'lastfm.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        wget_args = [
            ...
            "--warc-header", "lastfm-dld-script-version: " + VERSION,
            "--warc-header", ItemInterpolation("lastfm-user: %(item_name)s"),
        ]
...
project = Project(
    title="lastfm",
    project_html="""
        <img class="project-logo" alt="Project logo" src="http://archiveteam.org/images/6/6e/Last-fm-logo.png" height="50px" title=""/>
        <h2>www.last.fm <span class="links"><a href="http://www.last.fm/">Website</a> &middot; <a href="http://tracker.archiveteam.org/lastfm/">Leaderboard</a></span></h2>
        <p>Grabbing forums and profiles from last.fm.</p>
    """
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker("http://%s/%s" % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix="lastfm"),
    WgetDownload(
        WgetArgs(),
        max_tries=2,
